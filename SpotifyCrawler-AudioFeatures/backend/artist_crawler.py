...
"""
This class instantiates a Google Firestorm Database implemented as a FIFO 
queue with 350 known artists across many genres.
 
We call the Spotify API to get all related artists of a particular artist 
in the queue. If the artists does not already exists, they are added to the queue.
When an artists has been processed, they are stamped with a 'get-related-time' 
timestamp. 
